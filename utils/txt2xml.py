...
def save_xml_file(txt_dir,list_images,save_dir):
    ...
    for txt in txt_01:
        ...
        list_xml = Sort(txt_path)
        create_xml(list_xml,list_images,save_dir,txt)

if __name__ == '__main__':
    txt_dir = r"/Users/loufengbin/Documents/python/pythonProject/tensorflow/YOLO/yolov5-5.0/runs/detect/exp/labels"
    save_dir = "/Users/loufengbin/Documents/python/pythonProject/tensorflow/YOLO/yolov5-5.0/runs/detect/exp/xml"
